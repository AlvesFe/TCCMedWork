...
router.post('/', (req, res, next) => {
    ...
    mysql.getConnection((error, conn) => {
        ...
        conn.query(
            'INSERT INTO tbl_Receita_Remedio (Quantidade, fk_id_Receita, fk_id_Remedio)VALUES(?,?,?)',
            [req.body.Quantidade, req.body.fk_id_Receita, req.body.fk_id_Remedio],
...
router.get('/:id_Receita_Remedio', (req, res, next) => {
