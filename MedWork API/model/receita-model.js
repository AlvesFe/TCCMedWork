...
exports.detalhesReceita = (req, res, next) => {
    ...
    mysql.getConnection((error, conn) => {
        ...
        conn.query(`
        SELECT rm.id_Remedio, rm.bula, rm.descricao, rm.preco, rm.tarja, rc.dt_Emissao, rc.dt_Validade, rc.dosagem, rc.orientacoes, pc.nome AS Paciente, pc.cpf, pc.rg, pc.dt_Nascimento, pc.alergia, rr.Quantidade , md.nome AS Medico, md.dt_Nascimento as dt_Medico, md.especialidade, md.crm, rm.nome AS Remedio
