                    ...
                    <div className='row justify-content-center py-3'>
                        ...
                        <div className="col-12 py-2 form-row">
                            ...
                            <div className='form-group col-3 '>
                                ...
                                <input type="text" className="form-control form-control-sm" id="especiealidade" placeholder='Cirurgião' name='especiealidade' value={this.state.especiealidade} onChange={this.onChange} />
                            </div>
                            <div className='form-group col-3 '>
                            ...
                            <div className='form-group col-3 '>
                                ...
                                <input type="text" className="form-control form-control-sm" id="ativo" placeholder='1' name='ativo' value={this.state.ativo} onChange={this.onChange} />
                            </div>
