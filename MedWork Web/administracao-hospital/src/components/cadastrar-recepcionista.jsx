                    ...
                    <div className='row justify-content-center py-3'>
                        ...
                        <div className="col-12 py-5 form-row">
                            ...
                            <div className='form-group col-3 py-1'>
                                ...
                                <input type='date' className="form-control form-control-lg" id="dataNascimento" placeholder='DD/MM/AAAA' name='dataNascimento' value={this.state.dataNascimento} onChange={this.onChange} />
                            </div>
